...
Trinsic provides access to a variety of ID Providers through the Services, some of which may act as Sub-Processors. Customer may obtain a real-time report of currently-enabled Sub-Processor ID Providers utilized by Customer by emailing [legal@trinsic.id](mailto:legal@trinsic.id).
