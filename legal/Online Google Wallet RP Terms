...
2.  **Data Minimization.** You agree to not request that end users provide any End User Data for any purpose other than the purposes in Section 4.1. You agree to only request or access the specific End User Data from end users of your Product that are strictly required for verifying the end user's age, identity, or credentials and not any additional data.
...
4.  **Restrictions.**  You may not sell, as that term is defined under any applicable law, End User Data. In addition, unless strictly necessary for the purposes listed in Section 4.1 or explicitly required by applicable law, you may not:
...
5.  **Data Portability.  ** For as long as you use, process, or store any End User Data, you agree to enable your users to export their equivalent data to other services or applications of their choice in a way that\'s substantially as fast and easy as exporting such data from Google products and services, subject to applicable laws and security restrictions.

6.  **Accuracy.** End User Data may contain data, images, and messages that are controlled and updated solely by the third-party provider that issues them. You agree that Trinsic will not be responsible for any inaccuracies or errors in any data obtained through the Specified Service that was provided by the third-party issuer of the relevant credential.

**Section 5: Accessing and Using End User Data **

1.  **Google Controller-Controller Data Protection Terms.  **To the extent required by data protection laws applicable to your use of the Specified Service, you agree to be bound by the[[ Google Controller-Controller Data Protection Terms.]{.underline}](https://privacy.google.com/businesses/gdprcontrollerterms)
...
> You may revoke the permission to display your Brand Features for promotional or marketing purposes (as described in 6.1(b)) by giving Trinsic written notice and a reasonable period of time to facilitate the cessation of such use.

0.  **Publicity. ** You will not make any statement regarding your access or use of End User Data which suggests partnership with sponsorship by, or endorsement by Google, unless you have separately obtained Google\'s prior written approval.

```{=html}
<!-- -->
```
0.  **Retention of Rights. **Except as expressly stated in these Terms, these Terms do not grant either party any express or implied rights to the other's intellectual property. 
...
3.  **Indemnification.** You agree to indemnify, defend and hold harmless Trinsic and its affiliates, employees, agents, representatives and third-party service providers, for any and all claims, demands, actions, liability, fines, penalties and expenses that may arise from any of your acts through the use of the Specified Service. Such acts may include, but are not limited to, (a) your use (including any misuse) of the Specified Service, (b) your use of End User Data, or (c) breaches of any applicable law, rule, regulation or the Terms. 
